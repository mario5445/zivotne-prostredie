        ...
        <div class="chart-and-content">
            ...
            <div class="heading-secondary settings-heading">Nastavenia:</div>
                <div class="form-container">
                    <form class="setting-form" action="" method="GET">
                        <select name="lokalita" id="select" onchange="document.querySelector('.setting-form').submit()">
                            <?php 
                        ...
                        <select name="kategoria" id="select" onchange="document.querySelector('.setting-form').submit()">
                        <?php 
                        ...
                        <select name="datum" id="select" onchange="document.querySelector('.setting-form').submit()"> 
